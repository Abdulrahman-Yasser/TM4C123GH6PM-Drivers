...
const IntCtrl_Container_t Initialized_Interrupt_Container =
{
 ...
 .container_ptr={
         ...
         {Timer_1A_32, 0x5, IntCtrl_Enable},            {Timer_1B_32, 0x5, IntCtrl_Enable},
         {Timer_2A_32, 0x5, IntCtrl_Enable},            {Timer_2B_32, 0x5, IntCtrl_Enable},
         ...
         {UART5, 0x5, IntCtrl_Disable},                  {UART6, 0x5, IntCtrl_Disable},
         {UART7, 0x5, IntCtrl_Disable},                  {I2C2, 0x5, IntCtrl_Disable},
